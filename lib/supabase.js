...
function buildSupabaseUrl() {
    ...
    return `postgresql://postgres.hqmtygnjkquqsaosgkmr:${encodeURIComponent(password)}@aws-1-eu-west-1.pooler.supabase.com:5432/postgres`;
}

function getPool() {
    const dbUrl = buildSupabaseUrl() || process.env.DATABASE_URL;
    if (!pool && dbUrl) {
