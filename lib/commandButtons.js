...
const COMMAND_BUTTONS = {
    ...
    repo: {
        buttons: [
            { type: 'reply', text: '⭐ Star Repo', id: '{prefix}repo' },
    ...
    kick: {
        buttons: [
            ...
            { type: 'reply', text: '🚫 Ban User', id: '{prefix}ban' },
            { type: 'reply', text: '🏠 Menu', id: '{prefix}menu' }
        ]
    },
    promote: {
    ...
    update: {
        buttons: [
            { type: 'reply', text: '📋 Latest Updates', id: '{prefix}latestupdates' },
            { type: 'reply', text: '🔄 Restart', id: '{prefix}restart' },
            { type: 'reply', text: '🏠 Menu', id: '{prefix}menu' }
        ]
    }
};
