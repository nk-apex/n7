...
export const AUDIO_EFFECTS = {
  bass: {
    ...
    filter: 'equalizer=f=100:width_type=h:width=200:g=10'
  },
  bassboost: {
    name: 'bassboost',
    alias: ['heavybass'],
    ...
    filter: 'equalizer=f=80:width_type=h:width=200:g=15'
  },
  deepbass: {
    name: 'deepbass',
    alias: ['subbass'],
    ...
    filter: 'equalizer=f=50:width_type=h:width=100:g=20'
  },
  boost: {
    name: 'boost',
    alias: ['louder'],
  ...
  treble: {
    ...
    filter: 'equalizer=f=8000:width_type=h:width=2000:g=10'
  },
  vocalboost: {
    name: 'vocalboost',
    alias: ['vocals'],
  ...
  baby: {
    ...
    filter: 'asetrate=44100*1.5,aresample=44100,atempo=0.67'
  },
  demon: {
    name: 'demon',
    alias: ['devil', 'satan'],
  ...
  radio: {
    ...
    filter: 'highpass=f=300,lowpass=f=3000,volume=1.5'
  },
  telephone: {
    name: 'telephone',
    alias: ['phone', 'call'],
    ...
    filter: 'highpass=f=500,lowpass=f=3500'
  },
  underwater: {
    name: 'underwater',
    alias: ['submerged'],
    ...
    filter: 'lowpass=f=400,volume=0.8'
  }
};
...
export async function applyAudioEffect(sock, m, effectKey) {
  ...
  try {
    ...
    const fileSizeKB = (outputBuffer.length / 1024).toFixed(1);
